...
0000000080000000 <_entry>:
    ...
    80000004:	e8813103          	ld	sp,-376(sp) # 8000de88 <_GLOBAL_OFFSET_TABLE_+0x8>
...
start()
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    80000214:	7ff78793          	addi	a5,a5,2047 # ffffffffffffe7ff <end+0xffffffff7ffd74b7>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    80000328:	bac70713          	addi	a4,a4,-1108 # 80015ed0 <timer_scratch>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800004bc:	b5850513          	addi	a0,a0,-1192 # 80016010 <cons>
  ...
  while(n > 0){
    ...
    800004e6:	b2e50513          	addi	a0,a0,-1234 # 80016010 <cons>
    ...
    8000052e:	ae678793          	addi	a5,a5,-1306 # 80016010 <cons>
  ...
  release(&cons.lock);
    ...
    8000060e:	a0650513          	addi	a0,a0,-1530 # 80016010 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80000644:	9d050513          	addi	a0,a0,-1584 # 80016010 <cons>
  ...
  case C('U'):  // Kill line.
    ...
    80000712:	90270713          	addi	a4,a4,-1790 # 80016010 <cons>
  ...
  default:
    ...
    80000780:	89478793          	addi	a5,a5,-1900 # 80016010 <cons>
    80000784:	0a07a703          	lw	a4,160(a5)
    80000788:	00016797          	auipc	a5,0x16
    8000078c:	88878793          	addi	a5,a5,-1912 # 80016010 <cons>
    ...
    800007d0:	84478793          	addi	a5,a5,-1980 # 80016010 <cons>
    ...
    800007e4:	83070713          	addi	a4,a4,-2000 # 80016010 <cons>
    ...
    800007fe:	81668693          	addi	a3,a3,-2026 # 80016010 <cons>
    ...
    80000828:	00015797          	auipc	a5,0x15
    8000082c:	7e878793          	addi	a5,a5,2024 # 80016010 <cons>
    80000830:	0a07a703          	lw	a4,160(a5)
    80000834:	00015797          	auipc	a5,0x15
    80000838:	7dc78793          	addi	a5,a5,2012 # 80016010 <cons>
    ...
    8000084c:	02f71b63          	bne	a4,a5,80000882 <consoleintr+0x250>
        ...
        // has arrived.
        cons.w = cons.e;
    80000850:	00015797          	auipc	a5,0x15
    80000854:	7c078793          	addi	a5,a5,1984 # 80016010 <cons>
    80000858:	0a07a703          	lw	a4,160(a5)
    8000085c:	00015797          	auipc	a5,0x15
    80000860:	7b478793          	addi	a5,a5,1972 # 80016010 <cons>
    80000864:	08e7ae23          	sw	a4,156(a5)
        wakeup(&cons.r);
    80000868:	00016517          	auipc	a0,0x16
    8000086c:	84050513          	addi	a0,a0,-1984 # 800160a8 <cons+0x98>
  ...
  release(&cons.lock);
    80000884:	00015517          	auipc	a0,0x15
    80000888:	78c50513          	addi	a0,a0,1932 # 80016010 <cons>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    800008b2:	76250513          	addi	a0,a0,1890 # 80016010 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    800008ca:	8ea78793          	addi	a5,a5,-1814 # 800261b0 <devsw>
  ...
  devsw[CONSOLE].write = consolewrite;
    ...
    800008dc:	8d878793          	addi	a5,a5,-1832 # 800261b0 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    8000096e:	3e668693          	addi	a3,a3,998 # 8000dd50 <digits>
...
printptr(uint64 x)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80000a2a:	32a70713          	addi	a4,a4,810 # 8000dd50 <digits>
...
printf(char *fmt, ...)
{
  ...
  locking = pr.locking;
    ...
    80000a8c:	63078793          	addi	a5,a5,1584 # 800160b8 <pr>
  ...
  if(locking)
    ...
    80000aa2:	61a50513          	addi	a0,a0,1562 # 800160b8 <pr>
  ...
  if(locking)
    ...
    80000caa:	41250513          	addi	a0,a0,1042 # 800160b8 <pr>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80000cd0:	3ec78793          	addi	a5,a5,1004 # 800160b8 <pr>
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80000d08:	19c78793          	addi	a5,a5,412 # 8000dea0 <panicked>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80000dae:	32e50513          	addi	a0,a0,814 # 800160d8 <uart_tx_lock>
...
uartputc(int c)
{
  ...
  release(&uart_tx_lock);
    ...
    80000e6e:	26e50513          	addi	a0,a0,622 # 800160d8 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000e9e:	00678793          	addi	a5,a5,6 # 8000dea0 <panicked>
...
uartstart()
{
  ...
  while(1){
    ...
    80000ef4:	fb878793          	addi	a5,a5,-72 # 8000dea8 <uart_tx_w>
    80000ef8:	6398                	ld	a4,0(a5)
    80000efa:	0000d797          	auipc	a5,0xd
    80000efe:	fb678793          	addi	a5,a5,-74 # 8000deb0 <uart_tx_r>
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000ffa:	0e250513          	addi	a0,a0,226 # 800160d8 <uart_tx_lock>
  ...
  release(&uart_tx_lock);
    ...
    80001012:	0ca50513          	addi	a0,a0,202 # 800160d8 <uart_tx_lock>
...
kinit()
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    8000103c:	0d850513          	addi	a0,a0,216 # 80016110 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80001052:	2fa50513          	addi	a0,a0,762 # 80027348 <end>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    800010e0:	26c78793          	addi	a5,a5,620 # 80027348 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80001170:	fa450513          	addi	a0,a0,-92 # 80016110 <kmem>
    80001174:	00000097          	auipc	ra,0x0
    80001178:	150080e7          	jalr	336(ra) # 800012c4 <acquire>
  r = kmem.freelist;
    8000117c:	00015797          	auipc	a5,0x15
    80001180:	f9478793          	addi	a5,a5,-108 # 80016110 <kmem>
  ...
  if(r)
    ...
    8000119a:	f7a78793          	addi	a5,a5,-134 # 80016110 <kmem>
    8000119e:	ef98                	sd	a4,24(a5)
  release(&kmem.lock);
    800011a0:	00015517          	auipc	a0,0x15
    800011a4:	f7050513          	addi	a0,a0,-144 # 80016110 <kmem>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    8000192e:	80678793          	addi	a5,a5,-2042 # 80016130 <started>
    ...
    while(started == 0)
    80001938:	0001                	nop
    8000193a:	00014797          	auipc	a5,0x14
    8000193e:	7f678793          	addi	a5,a5,2038 # 80016130 <started>
...
kvminit(void)
{
  ...
  kernel_pagetable = kvmmake();
    ...
    80001ad8:	3e478793          	addi	a5,a5,996 # 8000deb8 <kernel_pagetable>
...
kvminithart()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80001afc:	3c078793          	addi	a5,a5,960 # 8000deb8 <kernel_pagetable>
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  last = PGROUNDDOWN(va + size - 1);
    ...
    80001d36:	fff78713          	addi	a4,a5,-1 # ffffffffffffefff <end+0xffffffff7ffd7cb7>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80002178:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0xffffffff7ffd7cb8>
    if((pte & PTE_V) && (pte & (PTE_R|PTE_W|PTE_X)) == 0){
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800026e4:	e5878793          	addi	a5,a5,-424 # 80016538 <proc>
    ...
    80002718:	e2478793          	addi	a5,a5,-476 # 80016538 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80002778:	00019797          	auipc	a5,0x19
    8000277c:	7c078793          	addi	a5,a5,1984 # 8001bf38 <pid_lock>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    800027a0:	00019517          	auipc	a0,0x19
    800027a4:	79850513          	addi	a0,a0,1944 # 8001bf38 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    800027b8:	00019517          	auipc	a0,0x19
    800027bc:	79850513          	addi	a0,a0,1944 # 8001bf50 <wait_lock>
    800027c0:	fffff097          	auipc	ra,0xfffff
    800027c4:	ad0080e7          	jalr	-1328(ra) # 80001290 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    800027c8:	00014797          	auipc	a5,0x14
    800027cc:	d7078793          	addi	a5,a5,-656 # 80016538 <proc>
    ...
    800027fc:	d4078793          	addi	a5,a5,-704 # 80016538 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000284a:	6f278793          	addi	a5,a5,1778 # 8001bf38 <pid_lock>
...
mycpu(void)
{
  ...
  struct cpu *c = &cpus[id];
    ...
    800028a4:	89878793          	addi	a5,a5,-1896 # 80016138 <cpus>
...
allocproc(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80002962:	bda78793          	addi	a5,a5,-1062 # 80016538 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800029a4:	59878793          	addi	a5,a5,1432 # 8001bf38 <pid_lock>
...
userinit(void)
{
  ...
  initproc = p;
    ...
    80002c54:	27078793          	addi	a5,a5,624 # 8000dec0 <initproc>
  ...
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    ...
    80002c6c:	10058593          	addi	a1,a1,256 # 8000dd68 <initcode>
...
fork(void)
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80002ee2:	07250513          	addi	a0,a0,114 # 8001bf50 <wait_lock>
  ...
  release(&wait_lock);
    ...
    80002efc:	05850513          	addi	a0,a0,88 # 8001bf50 <wait_lock>
...
reparent(struct proc *p)
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80002f4a:	5f278793          	addi	a5,a5,1522 # 80016538 <proc>
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80002f9a:	fa278793          	addi	a5,a5,-94 # 8001bf38 <pid_lock>
...
exit(int status)
{
  ...
  if(p == initproc)
    ...
    80002fcc:	ef878793          	addi	a5,a5,-264 # 8000dec0 <initproc>
  ...
  acquire(&wait_lock);
    ...
    8000307a:	eda50513          	addi	a0,a0,-294 # 8001bf50 <wait_lock>
  ...
  release(&wait_lock);
    ...
    800030c6:	e8e50513          	addi	a0,a0,-370 # 8001bf50 <wait_lock>
...
wait(uint64 addr)
{
  ...
  acquire(&wait_lock);
    ...
    80003106:	e4e50513          	addi	a0,a0,-434 # 8001bf50 <wait_lock>
  ...
  for(;;){
    ...
    8000311a:	42278793          	addi	a5,a5,1058 # 80016538 <proc>
    ...
    8000319a:	dba50513          	addi	a0,a0,-582 # 8001bf50 <wait_lock>
    ...
    800031c8:	d8c50513          	addi	a0,a0,-628 # 8001bf50 <wait_lock>
    ...
    800031fc:	d4078793          	addi	a5,a5,-704 # 8001bf38 <pid_lock>
    ...
    80003220:	d3450513          	addi	a0,a0,-716 # 8001bf50 <wait_lock>
    ...
    80003234:	d2058593          	addi	a1,a1,-736 # 8001bf50 <wait_lock>
...
scheduler(void)
{
  ...
  for(;;){
    ...
    80003278:	2c478793          	addi	a5,a5,708 # 80016538 <proc>
    ...
    800032f4:	c4878793          	addi	a5,a5,-952 # 8001bf38 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    ...
    80003446:	90278793          	addi	a5,a5,-1790 # 8000dd44 <first.1>
    ...
    80003452:	8f678793          	addi	a5,a5,-1802 # 8000dd44 <first.1>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80003502:	03a78793          	addi	a5,a5,58 # 80016538 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80003570:	9cc78793          	addi	a5,a5,-1588 # 8001bf38 <pid_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80003596:	fa678793          	addi	a5,a5,-90 # 80016538 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000360e:	92e78793          	addi	a5,a5,-1746 # 8001bf38 <pid_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800037a0:	d9c78793          	addi	a5,a5,-612 # 80016538 <proc>
    ...
    800037c8:	5dc70713          	addi	a4,a4,1500 # 8000dda0 <states.0>
    ...
    800037e2:	5c270713          	addi	a4,a4,1474 # 8000dda0 <states.0>
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80003850:	6ec78793          	addi	a5,a5,1772 # 8001bf38 <pid_lock>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80003aa6:	00018517          	auipc	a0,0x18
    80003aaa:	4c250513          	addi	a0,a0,1218 # 8001bf68 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    80003e88:	00018517          	auipc	a0,0x18
    80003e8c:	0e050513          	addi	a0,a0,224 # 8001bf68 <tickslock>
    80003e90:	ffffd097          	auipc	ra,0xffffd
    80003e94:	434080e7          	jalr	1076(ra) # 800012c4 <acquire>
  ticks++;
    80003e98:	0000a797          	auipc	a5,0xa
    80003e9c:	03078793          	addi	a5,a5,48 # 8000dec8 <ticks>
    80003ea0:	439c                	lw	a5,0(a5)
    80003ea2:	2785                	addiw	a5,a5,1
    80003ea4:	0007871b          	sext.w	a4,a5
    80003ea8:	0000a797          	auipc	a5,0xa
    80003eac:	02078793          	addi	a5,a5,32 # 8000dec8 <ticks>
    80003eb0:	c398                	sw	a4,0(a5)
  wakeup(&ticks);
    80003eb2:	0000a517          	auipc	a0,0xa
    80003eb6:	01650513          	addi	a0,a0,22 # 8000dec8 <ticks>
    80003eba:	fffff097          	auipc	ra,0xfffff
    80003ebe:	638080e7          	jalr	1592(ra) # 800034f2 <wakeup>
  release(&tickslock);
    80003ec2:	00018517          	auipc	a0,0x18
    80003ec6:	0a650513          	addi	a0,a0,166 # 8001bf68 <tickslock>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80004226:	0000a717          	auipc	a4,0xa
    8000422a:	baa70713          	addi	a4,a4,-1110 # 8000ddd0 <syscalls>
    ...
    8000423a:	0000a717          	auipc	a4,0xa
    8000423e:	b9670713          	addi	a4,a4,-1130 # 8000ddd0 <syscalls>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    8000439c:	00018517          	auipc	a0,0x18
    800043a0:	bcc50513          	addi	a0,a0,-1076 # 8001bf68 <tickslock>
    800043a4:	ffffd097          	auipc	ra,0xffffd
    800043a8:	f20080e7          	jalr	-224(ra) # 800012c4 <acquire>
  ticks0 = ticks;
    800043ac:	0000a797          	auipc	a5,0xa
    800043b0:	b1c78793          	addi	a5,a5,-1252 # 8000dec8 <ticks>
  ...
  while(ticks - ticks0 < n){
    ...
    800043d2:	cb99                	beqz	a5,800043e8 <sys_sleep+0x64>
      release(&tickslock);
    800043d4:	00018517          	auipc	a0,0x18
    800043d8:	b9450513          	addi	a0,a0,-1132 # 8001bf68 <tickslock>
    ...
    800043e8:	00018597          	auipc	a1,0x18
    800043ec:	b8058593          	addi	a1,a1,-1152 # 8001bf68 <tickslock>
    800043f0:	0000a517          	auipc	a0,0xa
    800043f4:	ad850513          	addi	a0,a0,-1320 # 8000dec8 <ticks>
    800043f8:	fffff097          	auipc	ra,0xfffff
    800043fc:	07e080e7          	jalr	126(ra) # 80003476 <sleep>
  while(ticks - ticks0 < n){
    80004400:	0000a797          	auipc	a5,0xa
    80004404:	ac878793          	addi	a5,a5,-1336 # 8000dec8 <ticks>
  ...
  release(&tickslock);
    ...
    8000441e:	b4e50513          	addi	a0,a0,-1202 # 8001bf68 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    80004470:	00018517          	auipc	a0,0x18
    80004474:	af850513          	addi	a0,a0,-1288 # 8001bf68 <tickslock>
    80004478:	ffffd097          	auipc	ra,0xffffd
    8000447c:	e4c080e7          	jalr	-436(ra) # 800012c4 <acquire>
  xticks = ticks;
    80004480:	0000a797          	auipc	a5,0xa
    80004484:	a4878793          	addi	a5,a5,-1464 # 8000dec8 <ticks>
    80004488:	439c                	lw	a5,0(a5)
    8000448a:	fef42623          	sw	a5,-20(s0)
  release(&tickslock);
    8000448e:	00018517          	auipc	a0,0x18
    80004492:	ada50513          	addi	a0,a0,-1318 # 8001bf68 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800044c0:	ac450513          	addi	a0,a0,-1340 # 8001bf80 <bcache>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80004528:	cc470713          	addi	a4,a4,-828 # 800241e8 <bcache+0x8268>
    ...
    8000454a:	a3a70713          	addi	a4,a4,-1478 # 8001bf80 <bcache>
    ...
    80004560:	a2470713          	addi	a4,a4,-1500 # 8001bf80 <bcache>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80004580:	c6c78793          	addi	a5,a5,-916 # 800241e8 <bcache+0x8268>
...
bget(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800045b2:	9d250513          	addi	a0,a0,-1582 # 8001bf80 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800045c2:	9c270713          	addi	a4,a4,-1598 # 8001bf80 <bcache>
    ...
    8000460a:	97a50513          	addi	a0,a0,-1670 # 8001bf80 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000463e:	bae78793          	addi	a5,a5,-1106 # 800241e8 <bcache+0x8268>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    8000464a:	93a70713          	addi	a4,a4,-1734 # 8001bf80 <bcache>
    ...
    8000468c:	8f850513          	addi	a0,a0,-1800 # 8001bf80 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    800046c0:	b2c78793          	addi	a5,a5,-1236 # 800241e8 <bcache+0x8268>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800047c8:	7bc50513          	addi	a0,a0,1980 # 8001bf80 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    8000480e:	77670713          	addi	a4,a4,1910 # 8001bf80 <bcache>
    ...
    80004828:	9c470713          	addi	a4,a4,-1596 # 800241e8 <bcache+0x8268>
    8000482c:	e7b8                	sd	a4,72(a5)
    bcache.head.next->prev = b;
    8000482e:	00017717          	auipc	a4,0x17
    80004832:	75270713          	addi	a4,a4,1874 # 8001bf80 <bcache>
    ...
    80004848:	73c70713          	addi	a4,a4,1852 # 8001bf80 <bcache>
  ...
  release(&bcache.lock);
    ...
    8000485c:	72850513          	addi	a0,a0,1832 # 8001bf80 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80004882:	70250513          	addi	a0,a0,1794 # 8001bf80 <bcache>
  ...
  release(&bcache.lock);
    ...
    800048a4:	6e050513          	addi	a0,a0,1760 # 8001bf80 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800048ca:	6ba50513          	addi	a0,a0,1722 # 8001bf80 <bcache>
  ...
  release(&bcache.lock);
    ...
    800048ec:	69850513          	addi	a0,a0,1688 # 8001bf80 <bcache>
...
fsinit(int dev) {
  ...
  readsb(dev, &sb);
    ...
    8000496e:	cd658593          	addi	a1,a1,-810 # 80024640 <sb>
  ...
  if(sb.magic != FSMAGIC)
    ...
    80004980:	cc478793          	addi	a5,a5,-828 # 80024640 <sb>
  ...
  initlog(dev, &sb);
    ...
    800049a6:	00020597          	auipc	a1,0x20
    800049aa:	c9a58593          	addi	a1,a1,-870 # 80024640 <sb>
...
balloc(uint dev)
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80004a58:	00020797          	auipc	a5,0x20
    80004a5c:	be878793          	addi	a5,a5,-1048 # 80024640 <sb>
    ...
    80004b76:	00020797          	auipc	a5,0x20
    80004b7a:	aca78793          	addi	a5,a5,-1334 # 80024640 <sb>
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80004b9e:	00020797          	auipc	a5,0x20
    80004ba2:	aa278793          	addi	a5,a5,-1374 # 80024640 <sb>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80004bf2:	00020797          	auipc	a5,0x20
    80004bf6:	a4e78793          	addi	a5,a5,-1458 # 80024640 <sb>
...
iinit()
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80004cf6:	00020517          	auipc	a0,0x20
    80004cfa:	96a50513          	addi	a0,a0,-1686 # 80024660 <itable>
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    80004d1c:	00020797          	auipc	a5,0x20
    80004d20:	94478793          	addi	a5,a5,-1724 # 80024660 <itable>
...
ialloc(uint dev, short type)
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80004d88:	00020797          	auipc	a5,0x20
    80004d8c:	8b878793          	addi	a5,a5,-1864 # 80024640 <sb>
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80004e30:	00020797          	auipc	a5,0x20
    80004e34:	81078793          	addi	a5,a5,-2032 # 80024640 <sb>
...
iupdate(struct inode *ip)
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80004e7e:	0001f797          	auipc	a5,0x1f
    80004e82:	7c278793          	addi	a5,a5,1986 # 80024640 <sb>
...
iget(uint dev, uint inum)
{
  ...
  acquire(&itable.lock);
    80004f5c:	0001f517          	auipc	a0,0x1f
    80004f60:	70450513          	addi	a0,a0,1796 # 80024660 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80004f70:	0001f797          	auipc	a5,0x1f
    80004f74:	70878793          	addi	a5,a5,1800 # 80024678 <itable+0x18>
    ...
    80004fb8:	c798                	sw	a4,8(a5)
      release(&itable.lock);
    80004fba:	0001f517          	auipc	a0,0x1f
    80004fbe:	6a650513          	addi	a0,a0,1702 # 80024660 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80004ff6:	00021797          	auipc	a5,0x21
    80004ffa:	11278793          	addi	a5,a5,274 # 80026108 <log>
  ...
  release(&itable.lock);
    80005044:	0001f517          	auipc	a0,0x1f
    80005048:	61c50513          	addi	a0,a0,1564 # 80024660 <itable>
...
idup(struct inode *ip)
{
  ...
  acquire(&itable.lock);
    8000506e:	0001f517          	auipc	a0,0x1f
    80005072:	5f250513          	addi	a0,a0,1522 # 80024660 <itable>
  ...
  release(&itable.lock);
    80005090:	0001f517          	auipc	a0,0x1f
    80005094:	5d050513          	addi	a0,a0,1488 # 80024660 <itable>
...
ilock(struct inode *ip)
{
  ...
  if(ip->valid == 0){
    ...
    80005106:	0001f797          	auipc	a5,0x1f
    8000510a:	53a78793          	addi	a5,a5,1338 # 80024640 <sb>
...
iput(struct inode *ip)
{
  ...
  acquire(&itable.lock);
    ...
    8000524c:	41850513          	addi	a0,a0,1048 # 80024660 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    release(&itable.lock);
    80005286:	0001f517          	auipc	a0,0x1f
    8000528a:	3da50513          	addi	a0,a0,986 # 80024660 <itable>
    ...
    acquire(&itable.lock);
    800052ce:	0001f517          	auipc	a0,0x1f
    800052d2:	39250513          	addi	a0,a0,914 # 80024660 <itable>
  ...
  release(&itable.lock);
    800052f0:	0001f517          	auipc	a0,0x1f
    800052f4:	37050513          	addi	a0,a0,880 # 80024660 <itable>
...
initlog(int dev, struct superblock *sb)
{
  ...
  initlock(&log.lock, "log");
    ...
    80005e46:	2c650513          	addi	a0,a0,710 # 80026108 <log>
  ...
  log.start = sb->logstart;
    ...
    80005e5a:	00020797          	auipc	a5,0x20
    80005e5e:	2ae78793          	addi	a5,a5,686 # 80026108 <log>
  ...
  log.size = sb->nlog;
    ...
    80005e70:	29c78793          	addi	a5,a5,668 # 80026108 <log>
    80005e74:	cfd8                	sw	a4,28(a5)
  log.dev = dev;
    80005e76:	00020797          	auipc	a5,0x20
    80005e7a:	29278793          	addi	a5,a5,658 # 80026108 <log>
...
install_trans(int recovering)
{
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80005eaa:	00020797          	auipc	a5,0x20
    80005eae:	25e78793          	addi	a5,a5,606 # 80026108 <log>
    80005eb2:	579c                	lw	a5,40(a5)
    80005eb4:	86be                	mv	a3,a5
    80005eb6:	00020797          	auipc	a5,0x20
    80005eba:	25278793          	addi	a5,a5,594 # 80026108 <log>
    ...
    80005edc:	00020797          	auipc	a5,0x20
    80005ee0:	22c78793          	addi	a5,a5,556 # 80026108 <log>
    80005ee4:	579c                	lw	a5,40(a5)
    80005ee6:	86be                	mv	a3,a5
    80005ee8:	00020717          	auipc	a4,0x20
    80005eec:	22070713          	addi	a4,a4,544 # 80026108 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80005f72:	19a78793          	addi	a5,a5,410 # 80026108 <log>
...
read_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80005f9a:	17278793          	addi	a5,a5,370 # 80026108 <log>
    80005f9e:	579c                	lw	a5,40(a5)
    80005fa0:	873e                	mv	a4,a5
    80005fa2:	00020797          	auipc	a5,0x20
    80005fa6:	16678793          	addi	a5,a5,358 # 80026108 <log>
  ...
  log.lh.n = lh->n;
    ...
    80005fce:	00020797          	auipc	a5,0x20
    80005fd2:	13a78793          	addi	a5,a5,314 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80005fec:	00020697          	auipc	a3,0x20
    80005ff0:	11c68693          	addi	a3,a3,284 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000600a:	00020797          	auipc	a5,0x20
    8000600e:	0fe78793          	addi	a5,a5,254 # 80026108 <log>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80006040:	0cc78793          	addi	a5,a5,204 # 80026108 <log>
    80006044:	579c                	lw	a5,40(a5)
    80006046:	873e                	mv	a4,a5
    80006048:	00020797          	auipc	a5,0x20
    8000604c:	0c078793          	addi	a5,a5,192 # 80026108 <log>
  ...
  int i;
  hb->n = log.lh.n;
    8000606e:	00020797          	auipc	a5,0x20
    80006072:	09a78793          	addi	a5,a5,154 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80006084:	00020717          	auipc	a4,0x20
    80006088:	08470713          	addi	a4,a4,132 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800060b0:	00020797          	auipc	a5,0x20
    800060b4:	05878793          	addi	a5,a5,88 # 80026108 <log>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    80006100:	00020797          	auipc	a5,0x20
    80006104:	00878793          	addi	a5,a5,8 # 80026108 <log>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000612a:	fe250513          	addi	a0,a0,-30 # 80026108 <log>
    8000612e:	ffffb097          	auipc	ra,0xffffb
    80006132:	196080e7          	jalr	406(ra) # 800012c4 <acquire>
  while(1){
    if(log.committing){
    80006136:	00020797          	auipc	a5,0x20
    8000613a:	fd278793          	addi	a5,a5,-46 # 80026108 <log>
    8000613e:	53dc                	lw	a5,36(a5)
    80006140:	cf91                	beqz	a5,8000615c <begin_op+0x3e>
      sleep(&log, &log.lock);
    80006142:	00020597          	auipc	a1,0x20
    80006146:	fc658593          	addi	a1,a1,-58 # 80026108 <log>
    8000614a:	00020517          	auipc	a0,0x20
    8000614e:	fbe50513          	addi	a0,a0,-66 # 80026108 <log>
    ...
    80006160:	fac78793          	addi	a5,a5,-84 # 80026108 <log>
    80006164:	57d8                	lw	a4,44(a5)
    80006166:	00020797          	auipc	a5,0x20
    8000616a:	fa278793          	addi	a5,a5,-94 # 80026108 <log>
...
end_op(void)
{
  ...
  if(log.outstanding == 0){
    ...
    80006236:	ed678793          	addi	a5,a5,-298 # 80026108 <log>
    ...
    log.committing = 1;
    80006244:	00020797          	auipc	a5,0x20
    80006248:	ec478793          	addi	a5,a5,-316 # 80026108 <log>
    ...
    wakeup(&log);
    80006252:	00020517          	auipc	a0,0x20
    80006256:	eb650513          	addi	a0,a0,-330 # 80026108 <log>
    8000625a:	ffffd097          	auipc	ra,0xffffd
    8000625e:	298080e7          	jalr	664(ra) # 800034f2 <wakeup>
  }
  release(&log.lock);
    80006262:	00020517          	auipc	a0,0x20
    80006266:	ea650513          	addi	a0,a0,-346 # 80026108 <log>
...
write_log(void)
{
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800062d6:	00020797          	auipc	a5,0x20
    800062da:	e3278793          	addi	a5,a5,-462 # 80026108 <log>
    800062de:	579c                	lw	a5,40(a5)
    800062e0:	86be                	mv	a3,a5
    800062e2:	00020797          	auipc	a5,0x20
    800062e6:	e2678793          	addi	a5,a5,-474 # 80026108 <log>
    ...
    80006308:	00020797          	auipc	a5,0x20
    8000630c:	e0078793          	addi	a5,a5,-512 # 80026108 <log>
    80006310:	579c                	lw	a5,40(a5)
    80006312:	86be                	mv	a3,a5
    80006314:	00020717          	auipc	a4,0x20
    80006318:	df470713          	addi	a4,a4,-524 # 80026108 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80006386:	00020797          	auipc	a5,0x20
    8000638a:	d8278793          	addi	a5,a5,-638 # 80026108 <log>
...
commit()
{
  ...
  if (log.lh.n > 0) {
    800063ae:	00020797          	auipc	a5,0x20
    800063b2:	d5a78793          	addi	a5,a5,-678 # 80026108 <log>
    ...
    log.lh.n = 0;
    800063d6:	00020797          	auipc	a5,0x20
    800063da:	d3278793          	addi	a5,a5,-718 # 80026108 <log>
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    80006424:	ce878793          	addi	a5,a5,-792 # 80026108 <log>
    80006428:	57d8                	lw	a4,44(a5)
    8000642a:	00020797          	auipc	a5,0x20
    8000642e:	cde78793          	addi	a5,a5,-802 # 80026108 <log>
  ...
  if (log.outstanding < 1)
    ...
    80006450:	cbc78793          	addi	a5,a5,-836 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80006474:	c9870713          	addi	a4,a4,-872 # 80026108 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000649e:	c6e78793          	addi	a5,a5,-914 # 80026108 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    800064ba:	00020717          	auipc	a4,0x20
    800064be:	c4e70713          	addi	a4,a4,-946 # 80026108 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    800064ce:	00020797          	auipc	a5,0x20
    800064d2:	c3a78793          	addi	a5,a5,-966 # 80026108 <log>
    ...
    log.lh.n++;
    800064ee:	00020797          	auipc	a5,0x20
    800064f2:	c1a78793          	addi	a5,a5,-998 # 80026108 <log>
    800064f6:	57dc                	lw	a5,44(a5)
    800064f8:	2785                	addiw	a5,a5,1
    800064fa:	0007871b          	sext.w	a4,a5
    800064fe:	00020797          	auipc	a5,0x20
    80006502:	c0a78793          	addi	a5,a5,-1014 # 80026108 <log>
    80006506:	d7d8                	sw	a4,44(a5)
  }
  release(&log.lock);
    80006508:	00020517          	auipc	a0,0x20
    8000650c:	c0050513          	addi	a0,a0,-1024 # 80026108 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800066a8:	bac50513          	addi	a0,a0,-1108 # 80026250 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800066ca:	b8a50513          	addi	a0,a0,-1142 # 80026250 <ftable>
    800066ce:	ffffb097          	auipc	ra,0xffffb
    800066d2:	bf6080e7          	jalr	-1034(ra) # 800012c4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800066d6:	00020797          	auipc	a5,0x20
    800066da:	b9278793          	addi	a5,a5,-1134 # 80026268 <ftable+0x18>
    ...
    800066f8:	b5c50513          	addi	a0,a0,-1188 # 80026250 <ftable>
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    ...
    80006716:	00021797          	auipc	a5,0x21
    8000671a:	af278793          	addi	a5,a5,-1294 # 80027208 <disk>
    8000671e:	fe843703          	ld	a4,-24(s0)
    80006722:	fcf761e3          	bltu	a4,a5,800066e4 <filealloc+0x26>
    }
  }
  release(&ftable.lock);
    80006726:	00020517          	auipc	a0,0x20
    8000672a:	b2a50513          	addi	a0,a0,-1238 # 80026250 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80006752:	b0250513          	addi	a0,a0,-1278 # 80026250 <ftable>
  ...
  release(&ftable.lock);
    ...
    8000678e:	ac650513          	addi	a0,a0,-1338 # 80026250 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800067b8:	a9c50513          	addi	a0,a0,-1380 # 80026250 <ftable>
  ...
  if(--f->ref > 0){
    ...
    800067fe:	a5650513          	addi	a0,a0,-1450 # 80026250 <ftable>
  ...
  release(&ftable.lock);
    ...
    80006842:	a1250513          	addi	a0,a0,-1518 # 80026250 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    800069ce:	0001f717          	auipc	a4,0x1f
    800069d2:	7e270713          	addi	a4,a4,2018 # 800261b0 <devsw>
    ...
    800069ea:	0001f717          	auipc	a4,0x1f
    800069ee:	7c670713          	addi	a4,a4,1990 # 800261b0 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80006b24:	0001f717          	auipc	a4,0x1f
    80006b28:	68c70713          	addi	a4,a4,1676 # 800261b0 <devsw>
    ...
    80006b40:	0001f717          	auipc	a4,0x1f
    80006b44:	67070713          	addi	a4,a4,1648 # 800261b0 <devsw>
...
exec(char *path, char **argv)
{
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80007402:	2785                	addiw	a5,a5,1 # fffffffffffff001 <end+0xffffffff7ffd7cb9>
...
virtio_disk_init(void)
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000895a:	0001f517          	auipc	a0,0x1f
    8000895e:	9d650513          	addi	a0,a0,-1578 # 80027330 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_BLK_F_CONFIG_WCE);
    ...
    80008a3e:	7ff78793          	addi	a5,a5,2047 # fffffffffffff7ff <end+0xffffffff7ffd84b7>
    80008a42:	8ff9                	and	a5,a5,a4
    80008a44:	fef43023          	sd	a5,-32(s0)
  features &= ~(1 << VIRTIO_BLK_F_MQ);
    80008a48:	fe043703          	ld	a4,-32(s0)
    80008a4c:	77fd                	lui	a5,0xfffff
    80008a4e:	17fd                	addi	a5,a5,-1 # ffffffffffffefff <end+0xffffffff7ffd7cb7>
  ...
  features &= ~(1 << VIRTIO_F_ANY_LAYOUT);
    ...
    80008a5e:	17fd                	addi	a5,a5,-1 # fffffffff7ffffff <end+0xffffffff77fd8cb7>
  ...
  features &= ~(1 << VIRTIO_RING_F_EVENT_IDX);
    ...
    80008a6e:	17fd                	addi	a5,a5,-1 # ffffffffdfffffff <end+0xffffffff5ffd8cb7>
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80008a7e:	17fd                	addi	a5,a5,-1 # ffffffffefffffff <end+0xffffffff6ffd8cb7>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80008b54:	6b878793          	addi	a5,a5,1720 # 80027208 <disk>
  ...
  disk.avail = kalloc();
    ...
    80008b68:	6a478793          	addi	a5,a5,1700 # 80027208 <disk>
  ...
  disk.used = kalloc();
    ...
    80008b78:	0001e797          	auipc	a5,0x1e
    80008b7c:	69078793          	addi	a5,a5,1680 # 80027208 <disk>
    80008b80:	eb98                	sd	a4,16(a5)
  if(!disk.desc || !disk.avail || !disk.used)
    80008b82:	0001e797          	auipc	a5,0x1e
    80008b86:	68678793          	addi	a5,a5,1670 # 80027208 <disk>
    80008b8a:	639c                	ld	a5,0(a5)
    80008b8c:	cf89                	beqz	a5,80008ba6 <virtio_disk_init+0x260>
    80008b8e:	0001e797          	auipc	a5,0x1e
    80008b92:	67a78793          	addi	a5,a5,1658 # 80027208 <disk>
    80008b96:	679c                	ld	a5,8(a5)
    80008b98:	c799                	beqz	a5,80008ba6 <virtio_disk_init+0x260>
    80008b9a:	0001e797          	auipc	a5,0x1e
    80008b9e:	66e78793          	addi	a5,a5,1646 # 80027208 <disk>
  ...
  memset(disk.desc, 0, PGSIZE);
    80008bb6:	0001e797          	auipc	a5,0x1e
    80008bba:	65278793          	addi	a5,a5,1618 # 80027208 <disk>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80008bd2:	63a78793          	addi	a5,a5,1594 # 80027208 <disk>
  ...
  memset(disk.used, 0, PGSIZE);
    ...
    80008bea:	62278793          	addi	a5,a5,1570 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_DESC_LOW) = (uint64)disk.desc;
    ...
    80008c0e:	5fe78793          	addi	a5,a5,1534 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_DESC_HIGH) = (uint64)disk.desc >> 32;
    80008c22:	0001e797          	auipc	a5,0x1e
    80008c26:	5e678793          	addi	a5,a5,1510 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_DRIVER_DESC_LOW) = (uint64)disk.avail;
    80008c3c:	0001e797          	auipc	a5,0x1e
    80008c40:	5cc78793          	addi	a5,a5,1484 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_DRIVER_DESC_HIGH) = (uint64)disk.avail >> 32;
    ...
    80008c58:	5b478793          	addi	a5,a5,1460 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_DEVICE_DESC_LOW) = (uint64)disk.used;
    ...
    80008c72:	59a78793          	addi	a5,a5,1434 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_DEVICE_DESC_HIGH) = (uint64)disk.used >> 32;
    ...
    80008c8a:	58278793          	addi	a5,a5,1410 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_READY) = 0x1;
  ...
  for(int i = 0; i < NUM; i++)
    ...
    disk.free[i] = 1;
    80008cb2:	0001e717          	auipc	a4,0x1e
    80008cb6:	55670713          	addi	a4,a4,1366 # 80027208 <disk>
...
alloc_desc()
{
  ...
  for(int i = 0; i < NUM; i++){
    ...
    if(disk.free[i]){
    80008d10:	0001e717          	auipc	a4,0x1e
    80008d14:	4f870713          	addi	a4,a4,1272 # 80027208 <disk>
    ...
    80008d22:	cf89                	beqz	a5,80008d3c <alloc_desc+0x3a>
      disk.free[i] = 0;
    80008d24:	0001e717          	auipc	a4,0x1e
    80008d28:	4e470713          	addi	a4,a4,1252 # 80027208 <disk>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    80008d8c:	0001e717          	auipc	a4,0x1e
    80008d90:	47c70713          	addi	a4,a4,1148 # 80027208 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80008db4:	45878793          	addi	a5,a5,1112 # 80027208 <disk>
  ...
  disk.desc[i].len = 0;
    80008dc6:	0001e797          	auipc	a5,0x1e
    80008dca:	44278793          	addi	a5,a5,1090 # 80027208 <disk>
  ...
  disk.desc[i].flags = 0;
    80008ddc:	0001e797          	auipc	a5,0x1e
    80008de0:	42c78793          	addi	a5,a5,1068 # 80027208 <disk>
  ...
  disk.desc[i].next = 0;
    80008df2:	0001e797          	auipc	a5,0x1e
    80008df6:	41678793          	addi	a5,a5,1046 # 80027208 <disk>
  ...
  disk.free[i] = 1;
    80008e08:	0001e717          	auipc	a4,0x1e
    80008e0c:	40070713          	addi	a4,a4,1024 # 80027208 <disk>
    80008e10:	fec42783          	lw	a5,-20(s0)
    80008e14:	97ba                	add	a5,a5,a4
    80008e16:	4705                	li	a4,1
    80008e18:	00e78c23          	sb	a4,24(a5)
  wakeup(&disk.free[0]);
    80008e1c:	0001e517          	auipc	a0,0x1e
    80008e20:	40450513          	addi	a0,a0,1028 # 80027220 <disk+0x18>
...
free_chain(int i)
{
  ...
  while(1){
    ...
    80008e44:	0001e797          	auipc	a5,0x1e
    80008e48:	3c478793          	addi	a5,a5,964 # 80027208 <disk>
    ...
    80008e5e:	0001e797          	auipc	a5,0x1e
    80008e62:	3aa78793          	addi	a5,a5,938 # 80027208 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    80008f70:	0001e517          	auipc	a0,0x1e
    80008f74:	3c050513          	addi	a0,a0,960 # 80027330 <disk+0x128>
  ...
  while(1){
    ...
    80008f92:	0001e597          	auipc	a1,0x1e
    80008f96:	39e58593          	addi	a1,a1,926 # 80027330 <disk+0x128>
    80008f9a:	0001e517          	auipc	a0,0x1e
    80008f9e:	28650513          	addi	a0,a0,646 # 80027220 <disk+0x18>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80008fb8:	0001e797          	auipc	a5,0x1e
    80008fbc:	25078793          	addi	a5,a5,592 # 80027208 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    ...
    80008ff8:	21478793          	addi	a5,a5,532 # 80027208 <disk>
  ...
  disk.desc[idx[0]].len = sizeof(struct virtio_blk_req);
    ...
    80009010:	1fc78793          	addi	a5,a5,508 # 80027208 <disk>
  ...
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    80009022:	0001e797          	auipc	a5,0x1e
    80009026:	1e678793          	addi	a5,a5,486 # 80027208 <disk>
  ...
  disk.desc[idx[0]].next = idx[1];
    ...
    8000903e:	0001e797          	auipc	a5,0x1e
    80009042:	1ca78793          	addi	a5,a5,458 # 80027208 <disk>
  ...
  disk.desc[idx[1]].addr = (uint64) b->data;
    ...
    80009062:	0001e797          	auipc	a5,0x1e
    80009066:	1a678793          	addi	a5,a5,422 # 80027208 <disk>
  ...
  disk.desc[idx[1]].len = BSIZE;
    80009078:	0001e797          	auipc	a5,0x1e
    8000907c:	19078793          	addi	a5,a5,400 # 80027208 <disk>
  ...
  if(write)
    ...
    8000909c:	17078793          	addi	a5,a5,368 # 80027208 <disk>
    ...
    800090b4:	15878793          	addi	a5,a5,344 # 80027208 <disk>
  ...
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    800090c8:	0001e797          	auipc	a5,0x1e
    800090cc:	14078793          	addi	a5,a5,320 # 80027208 <disk>
    ...
    800090de:	0001e797          	auipc	a5,0x1e
    800090e2:	12a78793          	addi	a5,a5,298 # 80027208 <disk>
  ...
  disk.desc[idx[1]].next = idx[2];
    ...
    80009100:	0001e797          	auipc	a5,0x1e
    80009104:	10878793          	addi	a5,a5,264 # 80027208 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    80009120:	0001e717          	auipc	a4,0x1e
    80009124:	0e870713          	addi	a4,a4,232 # 80027208 <disk>
  ...
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    ...
    8000913e:	0001e797          	auipc	a5,0x1e
    80009142:	0ca78793          	addi	a5,a5,202 # 80027208 <disk>
    80009146:	97ba                	add	a5,a5,a4
    80009148:	01078693          	addi	a3,a5,16
    8000914c:	0001e797          	auipc	a5,0x1e
    80009150:	0bc78793          	addi	a5,a5,188 # 80027208 <disk>
  ...
  disk.desc[idx[2]].len = 1;
    80009162:	0001e797          	auipc	a5,0x1e
    80009166:	0a678793          	addi	a5,a5,166 # 80027208 <disk>
  ...
  disk.desc[idx[2]].flags = VRING_DESC_F_WRITE; // device writes the status
    ...
    8000917c:	09078793          	addi	a5,a5,144 # 80027208 <disk>
  ...
  disk.desc[idx[2]].next = 0;
    ...
    80009194:	07878793          	addi	a5,a5,120 # 80027208 <disk>
  ...
  disk.info[idx[0]].b = b;
    ...
    800091b6:	05670713          	addi	a4,a4,86 # 80027208 <disk>
  ...
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    ...
    800091ca:	0001e797          	auipc	a5,0x1e
    800091ce:	03e78793          	addi	a5,a5,62 # 80027208 <disk>
    800091d2:	6794                	ld	a3,8(a5)
    800091d4:	0001e797          	auipc	a5,0x1e
    800091d8:	03478793          	addi	a5,a5,52 # 80027208 <disk>
  ...
  disk.avail->idx += 1; // not % NUM ...
    800091f8:	0001e797          	auipc	a5,0x1e
    800091fc:	01078793          	addi	a5,a5,16 # 80027208 <disk>
    80009200:	679c                	ld	a5,8(a5)
    80009202:	0027d703          	lhu	a4,2(a5)
    80009206:	0001e797          	auipc	a5,0x1e
    8000920a:	00278793          	addi	a5,a5,2 # 80027208 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    8000922c:	0001e597          	auipc	a1,0x1e
    80009230:	10458593          	addi	a1,a1,260 # 80027330 <disk+0x128>
  ...
  disk.info[idx[0]].b = 0;
    ...
    80009250:	0001e717          	auipc	a4,0x1e
    80009254:	fb870713          	addi	a4,a4,-72 # 80027208 <disk>
  ...
  release(&disk.vdisk_lock);
    80009270:	0001e517          	auipc	a0,0x1e
    80009274:	0c050513          	addi	a0,a0,192 # 80027330 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    80009292:	0001e517          	auipc	a0,0x1e
    80009296:	09e50513          	addi	a0,a0,158 # 80027330 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    800092cc:	f4078793          	addi	a5,a5,-192 # 80027208 <disk>
    800092d0:	6b98                	ld	a4,16(a5)
    800092d2:	0001e797          	auipc	a5,0x1e
    800092d6:	f3678793          	addi	a5,a5,-202 # 80027208 <disk>
    ...
    800092ee:	0001e717          	auipc	a4,0x1e
    800092f2:	f1a70713          	addi	a4,a4,-230 # 80027208 <disk>
    ...
    80009316:	0001e717          	auipc	a4,0x1e
    8000931a:	ef270713          	addi	a4,a4,-270 # 80027208 <disk>
    ...
    80009346:	ec678793          	addi	a5,a5,-314 # 80027208 <disk>
    8000934a:	0207d783          	lhu	a5,32(a5)
    8000934e:	2785                	addiw	a5,a5,1
    80009350:	03079713          	slli	a4,a5,0x30
    80009354:	9341                	srli	a4,a4,0x30
    80009356:	0001e797          	auipc	a5,0x1e
    8000935a:	eb278793          	addi	a5,a5,-334 # 80027208 <disk>
    8000935e:	02e79023          	sh	a4,32(a5)
  while(disk.used_idx != disk.used->idx){
    80009362:	0001e797          	auipc	a5,0x1e
    80009366:	ea678793          	addi	a5,a5,-346 # 80027208 <disk>
    8000936a:	0207d703          	lhu	a4,32(a5)
    8000936e:	0001e797          	auipc	a5,0x1e
    80009372:	e9a78793          	addi	a5,a5,-358 # 80027208 <disk>
  ...
  release(&disk.vdisk_lock);
    80009384:	0001e517          	auipc	a0,0x1e
    80009388:	fac50513          	addi	a0,a0,-84 # 80027330 <disk+0x128>
