...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     99e:	00002697          	auipc	a3,0x2
     9a2:	a4268693          	addi	a3,a3,-1470 # 23e0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a70:	00002717          	auipc	a4,0x2
     a74:	97070713          	addi	a4,a4,-1680 # 23e0 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     de0:	64478793          	addi	a5,a5,1604 # 2420 <freep>
     de4:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ed8:	54c78793          	addi	a5,a5,1356 # 2420 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f5a:	4ca78793          	addi	a5,a5,1226 # 2420 <freep>
     f5e:	639c                	ld	a5,0(a5)
}
     f60:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f8c:	49878793          	addi	a5,a5,1176 # 2420 <freep>
     f90:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     fa0:	47478793          	addi	a5,a5,1140 # 2410 <base>
     fa4:	fef43023          	sd	a5,-32(s0)
     fa8:	00001797          	auipc	a5,0x1
     fac:	47878793          	addi	a5,a5,1144 # 2420 <freep>
     fb0:	fe043703          	ld	a4,-32(s0)
     fb4:	e398                	sd	a4,0(a5)
     fb6:	00001797          	auipc	a5,0x1
     fba:	46a78793          	addi	a5,a5,1130 # 2420 <freep>
     fbe:	6398                	ld	a4,0(a5)
     fc0:	00001797          	auipc	a5,0x1
     fc4:	45078793          	addi	a5,a5,1104 # 2410 <base>
     fc8:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fca:	00001797          	auipc	a5,0x1
     fce:	44678793          	addi	a5,a5,1094 # 2410 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1048:	3dc78793          	addi	a5,a5,988 # 2420 <freep>
    ...
    105e:	3c678793          	addi	a5,a5,966 # 2420 <freep>
