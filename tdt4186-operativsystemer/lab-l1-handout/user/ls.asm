...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      92:	37250513          	addi	a0,a0,882 # 2400 <buf.0>
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      b6:	34e78793          	addi	a5,a5,846 # 2400 <buf.0>
  ...
  return buf;
      ...
      e8:	31c78793          	addi	a5,a5,796 # 2400 <buf.0>
}
      ec:	853e                	mv	a0,a5
      ee:	70e2                	ld	ra,56(sp)
      f0:	7442                	ld	s0,48(sp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     9a6:	00002697          	auipc	a3,0x2
     9aa:	a3a68693          	addi	a3,a3,-1478 # 23e0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a78:	00002717          	auipc	a4,0x2
     a7c:	96870713          	addi	a4,a4,-1688 # 23e0 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     de8:	63c78793          	addi	a5,a5,1596 # 2420 <freep>
     dec:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ee0:	54478793          	addi	a5,a5,1348 # 2420 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f62:	4c278793          	addi	a5,a5,1218 # 2420 <freep>
     f66:	639c                	ld	a5,0(a5)
}
     f68:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f94:	49078793          	addi	a5,a5,1168 # 2420 <freep>
     f98:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     fa8:	46c78793          	addi	a5,a5,1132 # 2410 <base>
     fac:	fef43023          	sd	a5,-32(s0)
     fb0:	00001797          	auipc	a5,0x1
     fb4:	47078793          	addi	a5,a5,1136 # 2420 <freep>
     fb8:	fe043703          	ld	a4,-32(s0)
     fbc:	e398                	sd	a4,0(a5)
     fbe:	00001797          	auipc	a5,0x1
     fc2:	46278793          	addi	a5,a5,1122 # 2420 <freep>
     fc6:	6398                	ld	a4,0(a5)
     fc8:	00001797          	auipc	a5,0x1
     fcc:	44878793          	addi	a5,a5,1096 # 2410 <base>
     fd0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fd2:	00001797          	auipc	a5,0x1
     fd6:	43e78793          	addi	a5,a5,1086 # 2410 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1050:	3d478793          	addi	a5,a5,980 # 2420 <freep>
    ...
    1066:	3be78793          	addi	a5,a5,958 # 2420 <freep>
