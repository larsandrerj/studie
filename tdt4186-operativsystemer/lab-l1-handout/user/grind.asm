...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    15a8:	e8c68693          	addi	a3,a3,-372 # 2430 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    167a:	dba70713          	addi	a4,a4,-582 # 2430 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    19e6:	e6678793          	addi	a5,a5,-410 # 2848 <freep>
  ...
  freep = p;
    ...
    1ade:	d6e78793          	addi	a5,a5,-658 # 2848 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b60:	cec78793          	addi	a5,a5,-788 # 2848 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b92:	cba78793          	addi	a5,a5,-838 # 2848 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c4e:	bfe78793          	addi	a5,a5,-1026 # 2848 <freep>
    ...
    1c64:	be878793          	addi	a5,a5,-1048 # 2848 <freep>
