 ...
 */
    ...
    lo = x % 127773;
      ...
      76:	677d                	lui	a4,0x1f
      78:	31d70713          	addi	a4,a4,797 # 1f31d <freep+0x1cad5>
    ...
    x = 16807 * lo - 2836 * hi;
      ...
      8a:	6791                	lui	a5,0x4
      8c:	1a778793          	addi	a5,a5,423 # 41a7 <freep+0x195f>
      90:	02f70733          	mul	a4,a4,a5
      94:	fe043683          	ld	a3,-32(s0)
      98:	77fd                	lui	a5,0xfffff
      9a:	4ec78793          	addi	a5,a5,1260 # fffffffffffff4ec <freep+0xffffffffffffcca4>
    ...
    x--;
      ...
      c6:	17fd                	addi	a5,a5,-1 # ffffffff7fffffff <freep+0xffffffff7fffd7b7>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      f2:	33250513          	addi	a0,a0,818 # 2420 <rand_next>
...
go(int which_child)
{
  ...
  while(1){
    ...
    int what = rand() % 23;
     ...
     1e8:	2c970713          	addi	a4,a4,713 # ffffffffb21642c9 <freep+0xffffffffb2161a81>
    ...
    if(what == 1){
     ...
     380:	0d458593          	addi	a1,a1,212 # 2450 <buf.0>
     384:	853e                	mv	a0,a5
     ...
     3aa:	0aa58593          	addi	a1,a1,170 # 2450 <buf.0>
     3ae:	853e                	mv	a0,a5
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    rand_next ^= 31;
     ...
     e38:	5ec78793          	addi	a5,a5,1516 # 2420 <rand_next>
     e3c:	639c                	ld	a5,0(a5)
     e3e:	01f7c713          	xori	a4,a5,31
     e42:	00001797          	auipc	a5,0x1
     e46:	5de78793          	addi	a5,a5,1502 # 2420 <rand_next>
     e4a:	e398                	sd	a4,0(a5)
    go(0);
     e4c:	4501                	li	a0,0
...
main()
{
  ...
  while(1){
    ...
    rand_next += 1;
     ...
     f70:	4b478793          	addi	a5,a5,1204 # 2420 <rand_next>
     f74:	639c                	ld	a5,0(a5)
     f76:	00178713          	addi	a4,a5,1
     f7a:	00001797          	auipc	a5,0x1
     f7e:	4a678793          	addi	a5,a5,1190 # 2420 <rand_next>
     f82:	e398                	sd	a4,0(a5)
  while(1){
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    15a0:	e9468693          	addi	a3,a3,-364 # 2430 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1672:	dc270713          	addi	a4,a4,-574 # 2430 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    19de:	e6e78793          	addi	a5,a5,-402 # 2848 <freep>
  ...
  freep = p;
    ...
    1ad6:	d7678793          	addi	a5,a5,-650 # 2848 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b58:	cf478793          	addi	a5,a5,-780 # 2848 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b8a:	cc278793          	addi	a5,a5,-830 # 2848 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c40:	c798                	sw	a4,8(a5)
      ...
      freep = prevp;
    1c42:	00001797          	auipc	a5,0x1
    1c46:	c0678793          	addi	a5,a5,-1018 # 2848 <freep>
    ...
    if(p == freep)
    1c58:	00001797          	auipc	a5,0x1
    1c5c:	bf078793          	addi	a5,a5,-1040 # 2848 <freep>
