...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	cbe68693          	addi	a3,a3,-834 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 7a8:	bec70713          	addi	a4,a4,-1044 # 1390 <digits>
...
free(void *ap)
{
 ...
 b14:	8b078793          	addi	a5,a5,-1872 # 13c0 <freep>
 b18:	639c                	ld	a5,0(a5)
 ...
 c0c:	7b878793          	addi	a5,a5,1976 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 cc0:	70478793          	addi	a5,a5,1796 # 13c0 <freep>
 cc4:	639c                	ld	a5,0(a5)
 ...
 cd4:	6e078793          	addi	a5,a5,1760 # 13b0 <base>
 cd8:	fef43023          	sd	a5,-32(s0)
 cdc:	00000797          	auipc	a5,0x0
 ce0:	6e478793          	addi	a5,a5,1764 # 13c0 <freep>
 ce4:	fe043703          	ld	a4,-32(s0)
 ce8:	e398                	sd	a4,0(a5)
 cea:	00000797          	auipc	a5,0x0
 cee:	6d678793          	addi	a5,a5,1750 # 13c0 <freep>
 cf2:	6398                	ld	a4,0(a5)
 cf4:	00000797          	auipc	a5,0x0
 cf8:	6bc78793          	addi	a5,a5,1724 # 13b0 <base>
 cfc:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 cfe:	00000797          	auipc	a5,0x0
 d02:	6b278793          	addi	a5,a5,1714 # 13b0 <base>
 ...
 d7c:	64878793          	addi	a5,a5,1608 # 13c0 <freep>
 ...
 d92:	63278793          	addi	a5,a5,1586 # 13c0 <freep>
 d96:	639c                	ld	a5,0(a5)
