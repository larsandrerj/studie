...
printint(int fd, int xx, int base, int sgn)
{
 ...
 644:	d5068693          	addi	a3,a3,-688 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 716:	c7e70713          	addi	a4,a4,-898 # 1390 <digits>
...
free(void *ap)
{
 ...
 a82:	94278793          	addi	a5,a5,-1726 # 13c0 <freep>
 a86:	639c                	ld	a5,0(a5)
...
morecore(uint nu)
{
 ...
 bec:	07c1                	addi	a5,a5,16 # 1010 <malloc+0x404>
 bee:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 c2e:	79678793          	addi	a5,a5,1942 # 13c0 <freep>
 c32:	639c                	ld	a5,0(a5)
 ...
 c42:	77278793          	addi	a5,a5,1906 # 13b0 <base>
 c46:	fef43023          	sd	a5,-32(s0)
 c4a:	00000797          	auipc	a5,0x0
 c4e:	77678793          	addi	a5,a5,1910 # 13c0 <freep>
 c52:	fe043703          	ld	a4,-32(s0)
 c56:	e398                	sd	a4,0(a5)
 c58:	00000797          	auipc	a5,0x0
 c5c:	76878793          	addi	a5,a5,1896 # 13c0 <freep>
 c60:	6398                	ld	a4,0(a5)
 c62:	00000797          	auipc	a5,0x0
 c66:	74e78793          	addi	a5,a5,1870 # 13b0 <base>
 c6a:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 c6c:	00000797          	auipc	a5,0x0
 c70:	74478793          	addi	a5,a5,1860 # 13b0 <base>
 ...
 cea:	6da78793          	addi	a5,a5,1754 # 13c0 <freep>
 ...
 d00:	6c478793          	addi	a5,a5,1732 # 13c0 <freep>
 d04:	639c                	ld	a5,0(a5)
