...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    155e:	11668693          	addi	a3,a3,278 # 2670 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1630:	04470713          	addi	a4,a4,68 # 2670 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199c:	d7078793          	addi	a5,a5,-656 # 2708 <freep>
  ...
  freep = p;
    ...
    1a94:	c7878793          	addi	a5,a5,-904 # 2708 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b16:	bf678793          	addi	a5,a5,-1034 # 2708 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b48:	bc478793          	addi	a5,a5,-1084 # 2708 <freep>
    1b4c:	639c                	ld	a5,0(a5)
    1b4e:	fef43023          	sd	a5,-32(s0)
    1b52:	fe043783          	ld	a5,-32(s0)
    1b56:	ef95                	bnez	a5,1b92 <malloc+0x6c>
    base.s.ptr = freep = prevp = &base;
    1b58:	00001797          	auipc	a5,0x1
    1b5c:	ba078793          	addi	a5,a5,-1120 # 26f8 <base>
    1b60:	fef43023          	sd	a5,-32(s0)
    1b64:	00001797          	auipc	a5,0x1
    1b68:	ba478793          	addi	a5,a5,-1116 # 2708 <freep>
    1b6c:	fe043703          	ld	a4,-32(s0)
    1b70:	e398                	sd	a4,0(a5)
    1b72:	00001797          	auipc	a5,0x1
    1b76:	b9678793          	addi	a5,a5,-1130 # 2708 <freep>
    1b7a:	6398                	ld	a4,0(a5)
    1b7c:	00001797          	auipc	a5,0x1
    1b80:	b7c78793          	addi	a5,a5,-1156 # 26f8 <base>
    1b84:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    1b86:	00001797          	auipc	a5,0x1
    1b8a:	b7278793          	addi	a5,a5,-1166 # 26f8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	b0878793          	addi	a5,a5,-1272 # 2708 <freep>
    ...
    1c1a:	af278793          	addi	a5,a5,-1294 # 2708 <freep>
