...
wc(int fd, char *name)
{
  ...
  40:	39470713          	addi	a4,a4,916 # 13d0 <buf>
  ...
  64:	37070713          	addi	a4,a4,880 # 13d0 <buf>
  ...
  ce:	30658593          	addi	a1,a1,774 # 13d0 <buf>
  d2:	853e                	mv	a0,a5
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 844:	00001697          	auipc	a3,0x1
 848:	b6c68693          	addi	a3,a3,-1172 # 13b0 <digits>
...
printptr(int fd, uint64 x) {
 ...
 916:	00001717          	auipc	a4,0x1
 91a:	a9a70713          	addi	a4,a4,-1382 # 13b0 <digits>
...
free(void *ap)
{
 ...
 c82:	00001797          	auipc	a5,0x1
 c86:	95e78793          	addi	a5,a5,-1698 # 15e0 <freep>
 c8a:	639c                	ld	a5,0(a5)
 ...
 d7e:	86678793          	addi	a5,a5,-1946 # 15e0 <freep>
...
malloc(uint nbytes)
{
 ...
 e32:	7b278793          	addi	a5,a5,1970 # 15e0 <freep>
 e36:	639c                	ld	a5,0(a5)
 ...
 e46:	78e78793          	addi	a5,a5,1934 # 15d0 <base>
 e4a:	fef43023          	sd	a5,-32(s0)
 e4e:	00000797          	auipc	a5,0x0
 e52:	79278793          	addi	a5,a5,1938 # 15e0 <freep>
 e56:	fe043703          	ld	a4,-32(s0)
 e5a:	e398                	sd	a4,0(a5)
 e5c:	00000797          	auipc	a5,0x0
 e60:	78478793          	addi	a5,a5,1924 # 15e0 <freep>
 e64:	6398                	ld	a4,0(a5)
 e66:	00000797          	auipc	a5,0x0
 e6a:	76a78793          	addi	a5,a5,1898 # 15d0 <base>
 e6e:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 e70:	00000797          	auipc	a5,0x0
 e74:	76078793          	addi	a5,a5,1888 # 15d0 <base>
 ...
 eee:	6f678793          	addi	a5,a5,1782 # 15e0 <freep>
 ...
 f04:	6e078793          	addi	a5,a5,1760 # 15e0 <freep>
 f08:	639c                	ld	a5,0(a5)
