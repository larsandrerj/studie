...
main(int argc, char *argv[])
{
  ...
  76:	d6658593          	addi	a1,a1,-666 # dd8 <malloc+0x160>
  7a:	4509                	li	a0,2
  7c:	00001097          	auipc	ra,0x1
  80:	9b0080e7          	jalr	-1616(ra) # a2c <fprintf>
  exit(0);
  84:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6b0:	ce468693          	addi	a3,a3,-796 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 782:	c1270713          	addi	a4,a4,-1006 # 1390 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 940:	4b478793          	addi	a5,a5,1204 # df0 <malloc+0x178>
...
free(void *ap)
{
 ...
 aee:	8d678793          	addi	a5,a5,-1834 # 13c0 <freep>
 af2:	639c                	ld	a5,0(a5)
 ...
 be6:	7de78793          	addi	a5,a5,2014 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 c9a:	72a78793          	addi	a5,a5,1834 # 13c0 <freep>
 c9e:	639c                	ld	a5,0(a5)
 ...
 cae:	70678793          	addi	a5,a5,1798 # 13b0 <base>
 cb2:	fef43023          	sd	a5,-32(s0)
 cb6:	00000797          	auipc	a5,0x0
 cba:	70a78793          	addi	a5,a5,1802 # 13c0 <freep>
 cbe:	fe043703          	ld	a4,-32(s0)
 cc2:	e398                	sd	a4,0(a5)
 cc4:	00000797          	auipc	a5,0x0
 cc8:	6fc78793          	addi	a5,a5,1788 # 13c0 <freep>
 ccc:	6398                	ld	a4,0(a5)
 cce:	00000797          	auipc	a5,0x0
 cd2:	6e278793          	addi	a5,a5,1762 # 13b0 <base>
 cd6:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 cd8:	00000797          	auipc	a5,0x0
 cdc:	6d878793          	addi	a5,a5,1752 # 13b0 <base>
 ...
 d56:	66e78793          	addi	a5,a5,1646 # 13c0 <freep>
 ...
 d6c:	65878793          	addi	a5,a5,1624 # 13c0 <freep>
 d70:	639c                	ld	a5,0(a5)
