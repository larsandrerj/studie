...
printint(int fd, int xx, int base, int sgn)
{
 ...
 73a:	c6a68693          	addi	a3,a3,-918 # 13a0 <digits>
...
printptr(int fd, uint64 x) {
 ...
 80c:	b9870713          	addi	a4,a4,-1128 # 13a0 <digits>
...
free(void *ap)
{
 ...
 b78:	85c78793          	addi	a5,a5,-1956 # 13d0 <freep>
 b7c:	639c                	ld	a5,0(a5)
 ...
 c70:	76478793          	addi	a5,a5,1892 # 13d0 <freep>
...
malloc(uint nbytes)
{
 ...
 d24:	6b078793          	addi	a5,a5,1712 # 13d0 <freep>
 d28:	639c                	ld	a5,0(a5)
 ...
 d38:	68c78793          	addi	a5,a5,1676 # 13c0 <base>
 d3c:	fef43023          	sd	a5,-32(s0)
 d40:	00000797          	auipc	a5,0x0
 d44:	69078793          	addi	a5,a5,1680 # 13d0 <freep>
 d48:	fe043703          	ld	a4,-32(s0)
 d4c:	e398                	sd	a4,0(a5)
 d4e:	00000797          	auipc	a5,0x0
 d52:	68278793          	addi	a5,a5,1666 # 13d0 <freep>
 d56:	6398                	ld	a4,0(a5)
 d58:	00000797          	auipc	a5,0x0
 d5c:	66878793          	addi	a5,a5,1640 # 13c0 <base>
 d60:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 d62:	00000797          	auipc	a5,0x0
 d66:	65e78793          	addi	a5,a5,1630 # 13c0 <base>
 ...
 de0:	5f478793          	addi	a5,a5,1524 # 13d0 <freep>
 ...
 df6:	5de78793          	addi	a5,a5,1502 # 13d0 <freep>
 dfa:	639c                	ld	a5,0(a5)
