...
main(void)
{
  ...
  a8:	2ec58593          	addi	a1,a1,748 # 1390 <argv>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 742:	c6268693          	addi	a3,a3,-926 # 13a0 <digits>
...
printptr(int fd, uint64 x) {
 ...
 814:	b9070713          	addi	a4,a4,-1136 # 13a0 <digits>
...
free(void *ap)
{
 ...
 b7c:	00001797          	auipc	a5,0x1
 b80:	85478793          	addi	a5,a5,-1964 # 13d0 <freep>
 b84:	639c                	ld	a5,0(a5)
 ...
 c78:	75c78793          	addi	a5,a5,1884 # 13d0 <freep>
...
malloc(uint nbytes)
{
 ...
 d2c:	6a878793          	addi	a5,a5,1704 # 13d0 <freep>
 d30:	639c                	ld	a5,0(a5)
 ...
 d40:	68478793          	addi	a5,a5,1668 # 13c0 <base>
 d44:	fef43023          	sd	a5,-32(s0)
 d48:	00000797          	auipc	a5,0x0
 d4c:	68878793          	addi	a5,a5,1672 # 13d0 <freep>
 d50:	fe043703          	ld	a4,-32(s0)
 d54:	e398                	sd	a4,0(a5)
 d56:	00000797          	auipc	a5,0x0
 d5a:	67a78793          	addi	a5,a5,1658 # 13d0 <freep>
 d5e:	6398                	ld	a4,0(a5)
 d60:	00000797          	auipc	a5,0x0
 d64:	66078793          	addi	a5,a5,1632 # 13c0 <base>
 d68:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 d6a:	00000797          	auipc	a5,0x0
 d6e:	65678793          	addi	a5,a5,1622 # 13c0 <base>
 ...
 de8:	5ec78793          	addi	a5,a5,1516 # 13d0 <freep>
 ...
 dfe:	5d678793          	addi	a5,a5,1494 # 13d0 <freep>
 e02:	639c                	ld	a5,0(a5)
