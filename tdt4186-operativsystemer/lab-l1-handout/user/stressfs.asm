...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7a4:	bf068693          	addi	a3,a3,-1040 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 876:	b1e70713          	addi	a4,a4,-1250 # 1390 <digits>
...
free(void *ap)
{
 ...
 be2:	7e278793          	addi	a5,a5,2018 # 13c0 <freep>
 be6:	639c                	ld	a5,0(a5)
 ...
 cda:	6ea78793          	addi	a5,a5,1770 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 d8e:	63678793          	addi	a5,a5,1590 # 13c0 <freep>
 d92:	639c                	ld	a5,0(a5)
 ...
 da2:	61278793          	addi	a5,a5,1554 # 13b0 <base>
 da6:	fef43023          	sd	a5,-32(s0)
 daa:	00000797          	auipc	a5,0x0
 dae:	61678793          	addi	a5,a5,1558 # 13c0 <freep>
 db2:	fe043703          	ld	a4,-32(s0)
 db6:	e398                	sd	a4,0(a5)
 db8:	00000797          	auipc	a5,0x0
 dbc:	60878793          	addi	a5,a5,1544 # 13c0 <freep>
 dc0:	6398                	ld	a4,0(a5)
 dc2:	00000797          	auipc	a5,0x0
 dc6:	5ee78793          	addi	a5,a5,1518 # 13b0 <base>
 dca:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 dcc:	00000797          	auipc	a5,0x0
 dd0:	5e478793          	addi	a5,a5,1508 # 13b0 <base>
 ...
 e4a:	57a78793          	addi	a5,a5,1402 # 13c0 <freep>
 ...
 e60:	56478793          	addi	a5,a5,1380 # 13c0 <freep>
 e64:	639c                	ld	a5,0(a5)
