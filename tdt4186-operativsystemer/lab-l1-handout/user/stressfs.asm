...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7ac:	be868693          	addi	a3,a3,-1048 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 87e:	b1670713          	addi	a4,a4,-1258 # 1390 <digits>
...
free(void *ap)
{
 ...
 bea:	7da78793          	addi	a5,a5,2010 # 13c0 <freep>
 bee:	639c                	ld	a5,0(a5)
 ...
 ce2:	6e278793          	addi	a5,a5,1762 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 d96:	62e78793          	addi	a5,a5,1582 # 13c0 <freep>
 d9a:	639c                	ld	a5,0(a5)
 ...
 daa:	60a78793          	addi	a5,a5,1546 # 13b0 <base>
 dae:	fef43023          	sd	a5,-32(s0)
 db2:	00000797          	auipc	a5,0x0
 db6:	60e78793          	addi	a5,a5,1550 # 13c0 <freep>
 dba:	fe043703          	ld	a4,-32(s0)
 dbe:	e398                	sd	a4,0(a5)
 dc0:	00000797          	auipc	a5,0x0
 dc4:	60078793          	addi	a5,a5,1536 # 13c0 <freep>
 dc8:	6398                	ld	a4,0(a5)
 dca:	00000797          	auipc	a5,0x0
 dce:	5e678793          	addi	a5,a5,1510 # 13b0 <base>
 dd2:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 dd4:	00000797          	auipc	a5,0x0
 dd8:	5dc78793          	addi	a5,a5,1500 # 13b0 <base>
 ...
 e52:	57278793          	addi	a5,a5,1394 # 13c0 <freep>
 ...
 e68:	55c78793          	addi	a5,a5,1372 # 13c0 <freep>
 e6c:	639c                	ld	a5,0(a5)
