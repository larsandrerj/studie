...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     a2e:	00002697          	auipc	a3,0x2
     a32:	a0268693          	addi	a3,a3,-1534 # 2430 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     b04:	93070713          	addi	a4,a4,-1744 # 2430 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     e70:	9f478793          	addi	a5,a5,-1548 # 2860 <freep>
     e74:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     f68:	8fc78793          	addi	a5,a5,-1796 # 2860 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     fea:	87a78793          	addi	a5,a5,-1926 # 2860 <freep>
     fee:	639c                	ld	a5,0(a5)
}
     ff0:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    101c:	84878793          	addi	a5,a5,-1976 # 2860 <freep>
    ...
    1030:	82478793          	addi	a5,a5,-2012 # 2850 <base>
    1034:	fef43023          	sd	a5,-32(s0)
    1038:	00002797          	auipc	a5,0x2
    103c:	82878793          	addi	a5,a5,-2008 # 2860 <freep>
    1040:	fe043703          	ld	a4,-32(s0)
    1044:	e398                	sd	a4,0(a5)
    1046:	00002797          	auipc	a5,0x2
    104a:	81a78793          	addi	a5,a5,-2022 # 2860 <freep>
    104e:	6398                	ld	a4,0(a5)
    1050:	00002797          	auipc	a5,0x2
    1054:	80078793          	addi	a5,a5,-2048 # 2850 <base>
    1058:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    105a:	00001797          	auipc	a5,0x1
    105e:	7f678793          	addi	a5,a5,2038 # 2850 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10d8:	78c78793          	addi	a5,a5,1932 # 2860 <freep>
    ...
    10ee:	77678793          	addi	a5,a5,1910 # 2860 <freep>
