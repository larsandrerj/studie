...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    if(m > 0){
      ...
      c8:	38c78793          	addi	a5,a5,908 # 2450 <buf>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     a36:	00002697          	auipc	a3,0x2
     a3a:	9fa68693          	addi	a3,a3,-1542 # 2430 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     b08:	00002717          	auipc	a4,0x2
     b0c:	92870713          	addi	a4,a4,-1752 # 2430 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     e74:	00002797          	auipc	a5,0x2
     e78:	9ec78793          	addi	a5,a5,-1556 # 2860 <freep>
     e7c:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     f70:	8f478793          	addi	a5,a5,-1804 # 2860 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     ff2:	87278793          	addi	a5,a5,-1934 # 2860 <freep>
     ff6:	639c                	ld	a5,0(a5)
}
     ff8:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10e0:	78478793          	addi	a5,a5,1924 # 2860 <freep>
    ...
    10f6:	76e78793          	addi	a5,a5,1902 # 2860 <freep>
