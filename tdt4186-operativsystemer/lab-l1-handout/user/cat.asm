...
cat(int fd)
{
  ...
  1a:	3ba58593          	addi	a1,a1,954 # 13d0 <buf>
  1e:	4505                	li	a0,1
  ...
  5e:	37658593          	addi	a1,a1,886 # 13d0 <buf>
  62:	853e                	mv	a0,a5
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 79a:	c1a68693          	addi	a3,a3,-998 # 13b0 <digits>
...
printptr(int fd, uint64 x) {
 ...
 86c:	b4870713          	addi	a4,a4,-1208 # 13b0 <digits>
...
free(void *ap)
{
 ...
 bd8:	a0c78793          	addi	a5,a5,-1524 # 15e0 <freep>
 bdc:	639c                	ld	a5,0(a5)
 ...
 cd0:	91478793          	addi	a5,a5,-1772 # 15e0 <freep>
...
malloc(uint nbytes)
{
 ...
 d84:	86078793          	addi	a5,a5,-1952 # 15e0 <freep>
 d88:	639c                	ld	a5,0(a5)
 ...
 d98:	83c78793          	addi	a5,a5,-1988 # 15d0 <base>
 d9c:	fef43023          	sd	a5,-32(s0)
 da0:	00001797          	auipc	a5,0x1
 da4:	84078793          	addi	a5,a5,-1984 # 15e0 <freep>
 da8:	fe043703          	ld	a4,-32(s0)
 dac:	e398                	sd	a4,0(a5)
 dae:	00001797          	auipc	a5,0x1
 db2:	83278793          	addi	a5,a5,-1998 # 15e0 <freep>
 db6:	6398                	ld	a4,0(a5)
 db8:	00001797          	auipc	a5,0x1
 dbc:	81878793          	addi	a5,a5,-2024 # 15d0 <base>
 dc0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 dc2:	00001797          	auipc	a5,0x1
 dc6:	80e78793          	addi	a5,a5,-2034 # 15d0 <base>
 ...
 e40:	7a478793          	addi	a5,a5,1956 # 15e0 <freep>
 ...
 e56:	78e78793          	addi	a5,a5,1934 # 15e0 <freep>
 e5a:	639c                	ld	a5,0(a5)
