...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7a2:	c1268693          	addi	a3,a3,-1006 # 13b0 <digits>
...
printptr(int fd, uint64 x) {
 ...
 874:	b4070713          	addi	a4,a4,-1216 # 13b0 <digits>
...
free(void *ap)
{
 ...
 be0:	a0478793          	addi	a5,a5,-1532 # 15e0 <freep>
 be4:	639c                	ld	a5,0(a5)
 ...
 cd8:	90c78793          	addi	a5,a5,-1780 # 15e0 <freep>
...
malloc(uint nbytes)
{
 ...
 d8c:	85878793          	addi	a5,a5,-1960 # 15e0 <freep>
 d90:	639c                	ld	a5,0(a5)
 ...
 da0:	83478793          	addi	a5,a5,-1996 # 15d0 <base>
 da4:	fef43023          	sd	a5,-32(s0)
 da8:	00001797          	auipc	a5,0x1
 dac:	83878793          	addi	a5,a5,-1992 # 15e0 <freep>
 db0:	fe043703          	ld	a4,-32(s0)
 db4:	e398                	sd	a4,0(a5)
 db6:	00001797          	auipc	a5,0x1
 dba:	82a78793          	addi	a5,a5,-2006 # 15e0 <freep>
 dbe:	6398                	ld	a4,0(a5)
 dc0:	00001797          	auipc	a5,0x1
 dc4:	81078793          	addi	a5,a5,-2032 # 15d0 <base>
 dc8:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 dca:	00001797          	auipc	a5,0x1
 dce:	80678793          	addi	a5,a5,-2042 # 15d0 <base>
 ...
 e48:	79c78793          	addi	a5,a5,1948 # 15e0 <freep>
 ...
 e5e:	78678793          	addi	a5,a5,1926 # 15e0 <freep>
 e62:	639c                	ld	a5,0(a5)
