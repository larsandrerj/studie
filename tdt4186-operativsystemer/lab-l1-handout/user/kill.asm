...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6a8:	cec68693          	addi	a3,a3,-788 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 77a:	c1a70713          	addi	a4,a4,-998 # 1390 <digits>
...
free(void *ap)
{
 ...
 ae6:	8de78793          	addi	a5,a5,-1826 # 13c0 <freep>
 aea:	639c                	ld	a5,0(a5)
 ...
 bde:	7e678793          	addi	a5,a5,2022 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 c92:	73278793          	addi	a5,a5,1842 # 13c0 <freep>
 c96:	639c                	ld	a5,0(a5)
 ...
 ca6:	70e78793          	addi	a5,a5,1806 # 13b0 <base>
 caa:	fef43023          	sd	a5,-32(s0)
 cae:	00000797          	auipc	a5,0x0
 cb2:	71278793          	addi	a5,a5,1810 # 13c0 <freep>
 ...
 cca:	6ea78793          	addi	a5,a5,1770 # 13b0 <base>
 cce:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 ...
 d4e:	67678793          	addi	a5,a5,1654 # 13c0 <freep>
