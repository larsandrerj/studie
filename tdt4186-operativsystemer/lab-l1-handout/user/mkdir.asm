...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ce:	cc668693          	addi	a3,a3,-826 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 7a0:	bf470713          	addi	a4,a4,-1036 # 1390 <digits>
...
free(void *ap)
{
 ...
 b0c:	8b878793          	addi	a5,a5,-1864 # 13c0 <freep>
 b10:	639c                	ld	a5,0(a5)
...
malloc(uint nbytes)
{
 ...
 cb8:	70c78793          	addi	a5,a5,1804 # 13c0 <freep>
 cbc:	639c                	ld	a5,0(a5)
 ...
 ccc:	6e878793          	addi	a5,a5,1768 # 13b0 <base>
 cd0:	fef43023          	sd	a5,-32(s0)
 cd4:	00000797          	auipc	a5,0x0
 cd8:	6ec78793          	addi	a5,a5,1772 # 13c0 <freep>
 cdc:	fe043703          	ld	a4,-32(s0)
 ce0:	e398                	sd	a4,0(a5)
 ce2:	00000797          	auipc	a5,0x0
 ce6:	6de78793          	addi	a5,a5,1758 # 13c0 <freep>
 cea:	6398                	ld	a4,0(a5)
 cec:	00000797          	auipc	a5,0x0
 cf0:	6c478793          	addi	a5,a5,1732 # 13b0 <base>
 cf4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 cf6:	00000797          	auipc	a5,0x0
 cfa:	6ba78793          	addi	a5,a5,1722 # 13b0 <base>
 ...
 d74:	65078793          	addi	a5,a5,1616 # 13c0 <freep>
 ...
 d8a:	63a78793          	addi	a5,a5,1594 # 13c0 <freep>
 d8e:	639c                	ld	a5,0(a5)
