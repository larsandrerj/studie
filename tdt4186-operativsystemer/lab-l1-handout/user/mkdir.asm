...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6c6:	cce68693          	addi	a3,a3,-818 # 1390 <digits>
...
printptr(int fd, uint64 x) {
 ...
 798:	bfc70713          	addi	a4,a4,-1028 # 1390 <digits>
...
free(void *ap)
{
 ...
 b04:	8c078793          	addi	a5,a5,-1856 # 13c0 <freep>
 b08:	639c                	ld	a5,0(a5)
 ...
 bfc:	7c878793          	addi	a5,a5,1992 # 13c0 <freep>
...
malloc(uint nbytes)
{
 ...
 cb0:	71478793          	addi	a5,a5,1812 # 13c0 <freep>
 cb4:	639c                	ld	a5,0(a5)
 ...
 cc4:	6f078793          	addi	a5,a5,1776 # 13b0 <base>
 cc8:	fef43023          	sd	a5,-32(s0)
 ccc:	00000797          	auipc	a5,0x0
 cd0:	6f478793          	addi	a5,a5,1780 # 13c0 <freep>
 cd4:	fe043703          	ld	a4,-32(s0)
 cd8:	e398                	sd	a4,0(a5)
 cda:	00000797          	auipc	a5,0x0
 cde:	6e678793          	addi	a5,a5,1766 # 13c0 <freep>
 ce2:	6398                	ld	a4,0(a5)
 ce4:	00000797          	auipc	a5,0x0
 ce8:	6cc78793          	addi	a5,a5,1740 # 13b0 <base>
 cec:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 cee:	00000797          	auipc	a5,0x0
 cf2:	6c278793          	addi	a5,a5,1730 # 13b0 <base>
 ...
 d82:	64278793          	addi	a5,a5,1602 # 13c0 <freep>
 d86:	639c                	ld	a5,0(a5)
