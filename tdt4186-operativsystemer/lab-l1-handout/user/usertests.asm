...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    7c24:	6f068693          	addi	a3,a3,1776 # c310 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    7cf2:	00004717          	auipc	a4,0x4
    7cf6:	61e70713          	addi	a4,a4,1566 # c310 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    8062:	afa78793          	addi	a5,a5,-1286 # 12b58 <freep>
  ...
  freep = p;
    8156:	0000b797          	auipc	a5,0xb
    815a:	a0278793          	addi	a5,a5,-1534 # 12b58 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    81d8:	0000b797          	auipc	a5,0xb
    81dc:	98078793          	addi	a5,a5,-1664 # 12b58 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    820a:	0000b797          	auipc	a5,0xb
    820e:	94e78793          	addi	a5,a5,-1714 # 12b58 <freep>
    8212:	639c                	ld	a5,0(a5)
    8214:	fef43023          	sd	a5,-32(s0)
    8218:	fe043783          	ld	a5,-32(s0)
    821c:	ef95                	bnez	a5,8258 <malloc+0x6c>
    base.s.ptr = freep = prevp = &base;
    821e:	0000b797          	auipc	a5,0xb
    8222:	92a78793          	addi	a5,a5,-1750 # 12b48 <base>
    8226:	fef43023          	sd	a5,-32(s0)
    822a:	0000b797          	auipc	a5,0xb
    822e:	92e78793          	addi	a5,a5,-1746 # 12b58 <freep>
    8232:	fe043703          	ld	a4,-32(s0)
    8236:	e398                	sd	a4,0(a5)
    8238:	0000b797          	auipc	a5,0xb
    823c:	92078793          	addi	a5,a5,-1760 # 12b58 <freep>
    8240:	6398                	ld	a4,0(a5)
    8242:	0000b797          	auipc	a5,0xb
    8246:	90678793          	addi	a5,a5,-1786 # 12b48 <base>
    824a:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    824c:	0000b797          	auipc	a5,0xb
    8250:	8fc78793          	addi	a5,a5,-1796 # 12b48 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    82c4:	c798                	sw	a4,8(a5)
      ...
      freep = prevp;
    82c6:	0000b797          	auipc	a5,0xb
    82ca:	89278793          	addi	a5,a5,-1902 # 12b58 <freep>
    ...
    if(p == freep)
    82dc:	0000b797          	auipc	a5,0xb
    82e0:	87c78793          	addi	a5,a5,-1924 # 12b58 <freep>
