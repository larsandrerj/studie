  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     614:	a00d                	j	636 <copyinstr2+0x1e4>
      big[i] = 'x';
     616:	00011717          	auipc	a4,0x11
     61a:	42a70713          	addi	a4,a4,1066 # 11a40 <big.0>
    ...
    big[PGSIZE] = '\0';
     644:	00011717          	auipc	a4,0x11
     648:	3fc70713          	addi	a4,a4,1020 # 11a40 <big.0>
     64c:	6785                	lui	a5,0x1
...
writetest(char *s)
{
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15b6:	d7e58593          	addi	a1,a1,-642 # c330 <buf>
    15ba:	853e                	mv	a0,a5
...
writebig(char *s)
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    169c:	c9878793          	addi	a5,a5,-872 # c330 <buf>
    ...
    16b2:	c8258593          	addi	a1,a1,-894 # c330 <buf>
    16b6:	853e                	mv	a0,a5
  ...
  for(;;){
    ...
    1760:	0000b597          	auipc	a1,0xb
    1764:	bd058593          	addi	a1,a1,-1072 # c330 <buf>
    1768:	853e                	mv	a0,a5
    ...
    if(((int*)buf)[0] != n){
    17e8:	0000b797          	auipc	a5,0xb
    17ec:	b4878793          	addi	a5,a5,-1208 # c330 <buf>
    ...
    17f8:	02f70a63          	beq	a4,a5,182c <writebig+0x1e8>
      printf("%s: read content of block %d is %d\n", s,
             n, ((int*)buf)[0]);
    17fc:	0000b797          	auipc	a5,0xb
    1800:	b3478793          	addi	a5,a5,-1228 # c330 <buf>
      printf("%s: read content of block %d is %d\n", s,
...
pipe1(char *s)
{
  ...
  if(pid == 0){
    ...
    1cf6:	0000a697          	auipc	a3,0xa
    1cfa:	63a68693          	addi	a3,a3,1594 # c330 <buf>
    ...
    1d2a:	0000a597          	auipc	a1,0xa
    1d2e:	60658593          	addi	a1,a1,1542 # c330 <buf>
    1d32:	853e                	mv	a0,a5
    ...
    1db2:	0000a717          	auipc	a4,0xa
    1db6:	57e70713          	addi	a4,a4,1406 # c330 <buf>
    ...
    1e44:	863a                	mv	a2,a4
    1e46:	0000a597          	auipc	a1,0xa
    1e4a:	4ea58593          	addi	a1,a1,1258 # c330 <buf>
    1e4e:	853e                	mv	a0,a5
...
preempt(char *s)
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    20fc:	0000a597          	auipc	a1,0xa
    2100:	23458593          	addi	a1,a1,564 # c330 <buf>
    2104:	853e                	mv	a0,a5
...
fourfiles(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2b5a:	7da50513          	addi	a0,a0,2010 # c330 <buf>
    ...
    2b78:	7bc58593          	addi	a1,a1,1980 # c330 <buf>
    2b7c:	853e                	mv	a0,a5
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2c72:	6c270713          	addi	a4,a4,1730 # c330 <buf>
    ...
    2ce2:	00009597          	auipc	a1,0x9
    2ce6:	64e58593          	addi	a1,a1,1614 # c330 <buf>
    2cea:	853e                	mv	a0,a5
...
unlinkread(char *s)
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    31fc:	00009597          	auipc	a1,0x9
    3200:	13458593          	addi	a1,a1,308 # c330 <buf>
    3204:	853e                	mv	a0,a5
  ...
  if(buf[0] != 'h'){
    3236:	00009797          	auipc	a5,0x9
    323a:	0fa78793          	addi	a5,a5,250 # c330 <buf>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    326e:	4629                	li	a2,10
    3270:	00009597          	auipc	a1,0x9
    3274:	0c058593          	addi	a1,a1,192 # c330 <buf>
    3278:	853e                	mv	a0,a5
...
linktest(char *s)
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3456:	00009597          	auipc	a1,0x9
    345a:	eda58593          	addi	a1,a1,-294 # c330 <buf>
    345e:	853e                	mv	a0,a5
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    35ce:	55670713          	addi	a4,a4,1366 # 55555556 <freep+0x555429fe>
    ...
    3620:	66770713          	addi	a4,a4,1639 # 66666667 <freep+0x66653b0f>
  ...
  for(i = 0; i < N; i++){
    ...
    389a:	55670713          	addi	a4,a4,1366 # 55555556 <freep+0x555429fe>
    ...
    38ce:	55670713          	addi	a4,a4,1366 # 55555556 <freep+0x555429fe>
...
linkunlink(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    3ab2:	e6d7879b          	addiw	a5,a5,-403 # 41c64e6d <freep+0x41c52315>
...
subdir(char *s)
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3d8a:	00008597          	auipc	a1,0x8
    3d8e:	5a658593          	addi	a1,a1,1446 # c330 <buf>
    3d92:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3db0:	00008797          	auipc	a5,0x8
    3db4:	58078793          	addi	a5,a5,1408 # c330 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3fa2:	00008597          	auipc	a1,0x8
    3fa6:	38e58593          	addi	a1,a1,910 # c330 <buf>
    3faa:	853e                	mv	a0,a5
...
bigwrite(char *s)
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44be:	863a                	mv	a2,a4
    44c0:	00008597          	auipc	a1,0x8
    44c4:	e7058593          	addi	a1,a1,-400 # c330 <buf>
    44c8:	853e                	mv	a0,a5
...
bigfile(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    45dc:	85be                	mv	a1,a5
    45de:	00008517          	auipc	a0,0x8
    45e2:	d5250513          	addi	a0,a0,-686 # c330 <buf>
    45e6:	00003097          	auipc	ra,0x3
    45ea:	128080e7          	jalr	296(ra) # 770e <memset>
    if(write(fd, buf, SZ) != SZ){
    45ee:	fe442783          	lw	a5,-28(s0)
    45f2:	25800613          	li	a2,600
    45f6:	00008597          	auipc	a1,0x8
    45fa:	d3a58593          	addi	a1,a1,-710 # c330 <buf>
    45fe:	853e                	mv	a0,a5
  ...
  for(i = 0; ; i++){
    ...
    46a8:	00008597          	auipc	a1,0x8
    46ac:	c8858593          	addi	a1,a1,-888 # c330 <buf>
    46b0:	853e                	mv	a0,a5
    ...
    471e:	00008797          	auipc	a5,0x8
    4722:	c1278793          	addi	a5,a5,-1006 # c330 <buf>
    ...
    4742:	00008797          	auipc	a5,0x8
    4746:	bee78793          	addi	a5,a5,-1042 # c330 <buf>
...
sbrkbasic(char *s)
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    *b = 1;
    ...
    51f6:	4705                	li	a4,1
    51f8:	00e78023          	sb	a4,0(a5) # 40000000 <freep+0x3ffed4a8>
    a = b + 1;
...
sbrkmuch(char *s)
{
  ...
  lastaddr = (char*) (BIG-1);
    ...
    5382:	17fd                	addi	a5,a5,-1 # 63fffff <freep+0x63ed4a7>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    55c8:	35078793          	addi	a5,a5,848 # c350 <buf+0x20>
    ...
    55dc:	47f78793          	addi	a5,a5,1151 # 1003d47f <freep+0x1002a927>
...
MAXVAplus(char *s)
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    564e:	00f70023          	sb	a5,0(a4) # 6400000 <freep+0x63ed4a8>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    5ab8:	0000a717          	auipc	a4,0xa
    5abc:	87870713          	addi	a4,a4,-1928 # f330 <uninit>
...
bigargtest(char *s)
{
  ...
  if(pid == 0){
    ...
    5b46:	0000d717          	auipc	a4,0xd
    5b4a:	f0270713          	addi	a4,a4,-254 # 12a48 <args.1>
    ...
    args[MAXARG-1] = 0;
    5b78:	0000d797          	auipc	a5,0xd
    5b7c:	ed078793          	addi	a5,a5,-304 # 12a48 <args.1>
    5b80:	0e07bc23          	sd	zero,248(a5)
    exec("echo", args);
    5b84:	0000d597          	auipc	a1,0xd
    5b88:	ec458593          	addi	a1,a1,-316 # 12a48 <args.1>
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ca6:	dd378793          	addi	a5,a5,-557 # 10624dd3 <freep+0x1061227b>
    ...
    5cdc:	dd370713          	addi	a4,a4,-557 # 10624dd3 <freep+0x1061227b>
    ...
    5d0c:	51f78793          	addi	a5,a5,1311 # 51eb851f <freep+0x51ea59c7>
    ...
    5d42:	51f70713          	addi	a4,a4,1311 # 51eb851f <freep+0x51ea59c7>
    ...
    5d72:	66778793          	addi	a5,a5,1639 # 66666667 <freep+0x66653b0f>
    ...
    5daa:	66778793          	addi	a5,a5,1639 # 66666667 <freep+0x66653b0f>
    ...
    5e46:	00006597          	auipc	a1,0x6
    5e4a:	4ea58593          	addi	a1,a1,1258 # c330 <buf>
    5e4e:	853e                	mv	a0,a5
  ...
  while(nfiles >= 0){
    ...
    5ede:	dd378793          	addi	a5,a5,-557 # 10624dd3 <freep+0x1061227b>
    ...
    5f14:	dd370713          	addi	a4,a4,-557 # 10624dd3 <freep+0x1061227b>
    ...
    5f44:	51f78793          	addi	a5,a5,1311 # 51eb851f <freep+0x51ea59c7>
    ...
    5f7a:	51f70713          	addi	a4,a4,1311 # 51eb851f <freep+0x51ea59c7>
    ...
    5faa:	66778793          	addi	a5,a5,1639 # 66666667 <freep+0x66653b0f>
    ...
    5fe2:	66778793          	addi	a5,a5,1639 # 66666667 <freep+0x66653b0f>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    6124:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <freep+0xfffffffffffec4a8>
...
pgbug(char *s)
{
  ...
  exec(big, argv);
    6242:	00006797          	auipc	a5,0x6
    6246:	c7e78793          	addi	a5,a5,-898 # bec0 <big>
  ...
  pipe(big);
    625c:	00006797          	auipc	a5,0x6
    6260:	c6478793          	addi	a5,a5,-924 # bec0 <big>
...
sbrk8000(char *s)
{
  ...
  sbrk(0x80000004);
    ...
    652c:	00478513          	addi	a0,a5,4 # ffffffff80000004 <freep+0xffffffff7ffed4ac>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    65b6:	34f78793          	addi	a5,a5,847 # c34f <buf+0x1f>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    689a:	863a                	mv	a2,a4
    689c:	00006597          	auipc	a1,0x6
    68a0:	a9458593          	addi	a1,a1,-1388 # c330 <buf>
    68a4:	853e                	mv	a0,a5
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    73e0:	00005517          	auipc	a0,0x5
    73e4:	af050513          	addi	a0,a0,-1296 # bed0 <quicktests>
    ...
    7428:	00005517          	auipc	a0,0x5
    742c:	e7850513          	addi	a0,a0,-392 # c2a0 <slowtests>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    7c1c:	6f868693          	addi	a3,a3,1784 # c310 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    7cea:	00004717          	auipc	a4,0x4
    7cee:	62670713          	addi	a4,a4,1574 # c310 <digits>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    8056:	0000b797          	auipc	a5,0xb
    805a:	b0278793          	addi	a5,a5,-1278 # 12b58 <freep>
  ...
  freep = p;
    814e:	0000b797          	auipc	a5,0xb
    8152:	a0a78793          	addi	a5,a5,-1526 # 12b58 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    81d0:	0000b797          	auipc	a5,0xb
    81d4:	98878793          	addi	a5,a5,-1656 # 12b58 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    8202:	0000b797          	auipc	a5,0xb
    8206:	95678793          	addi	a5,a5,-1706 # 12b58 <freep>
    820a:	639c                	ld	a5,0(a5)
    820c:	fef43023          	sd	a5,-32(s0)
    8210:	fe043783          	ld	a5,-32(s0)
    8214:	ef95                	bnez	a5,8250 <malloc+0x6c>
    base.s.ptr = freep = prevp = &base;
    8216:	0000b797          	auipc	a5,0xb
    821a:	93278793          	addi	a5,a5,-1742 # 12b48 <base>
    821e:	fef43023          	sd	a5,-32(s0)
    8222:	0000b797          	auipc	a5,0xb
    8226:	93678793          	addi	a5,a5,-1738 # 12b58 <freep>
    822a:	fe043703          	ld	a4,-32(s0)
    822e:	e398                	sd	a4,0(a5)
    8230:	0000b797          	auipc	a5,0xb
    8234:	92878793          	addi	a5,a5,-1752 # 12b58 <freep>
    8238:	6398                	ld	a4,0(a5)
    823a:	0000b797          	auipc	a5,0xb
    823e:	90e78793          	addi	a5,a5,-1778 # 12b48 <base>
    8242:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    8244:	0000b797          	auipc	a5,0xb
    8248:	90478793          	addi	a5,a5,-1788 # 12b48 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    82bc:	c798                	sw	a4,8(a5)
      ...
      freep = prevp;
    82be:	0000b797          	auipc	a5,0xb
    82c2:	89a78793          	addi	a5,a5,-1894 # 12b58 <freep>
    ...
    if(p == freep)
    82d4:	0000b797          	auipc	a5,0xb
    82d8:	88478793          	addi	a5,a5,-1916 # 12b58 <freep>
